...
class ContratosIn
{
    ...
    public function sendMail($numContrato,$txtRechazo)
    {
        ...
        $contenido = '<html><body>';
		$contenido .= '<h2>Contratos en SAP Rechazados</h2>';	
		$contenido .= '<hr />';
		$contenido .= '<p>El numero de Contrato <span style="color: #0000FF; font-size: 12pt">'. $numContrato. '</span>  ha sido rechazada debido a :</p>';
        ...
        $msgMail=mail ($maildest, "Liberacion de Contratos", $contenido, "From: $email\nContent-Type: text/html; charset=iso-8859-1\nContent-Transfer-Encoding: 8bit");
        if($msgMail){
            $msg="S";
        }else{
            $msg="E";
