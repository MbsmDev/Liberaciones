            ...
            <div class="modal-body">
                <form name="formRP" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <button type="button" hidden id="grupoL"></button>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if (rolL == 'UsuarioMC') {
            ...
            showTableP(codigoL,'DI','1');
            showTableP(codigoL,'IN','1');
            showTableP(codigoL,'CO','1');
            showTableP(codigoL,'03','1');
            showTableP(codigoL,'02','1');
            showTableP(codigoL,'07','1');
    ...
    function showTableP(codigoL,grupoL,tipo) {
    ...
    $( "#envRechazo" ).on( "click", function() {
        ...
        var coLi = $("#coLi").val();
        var grupoL = $("#grupoL").val();
        rechazarPedido(numPedido,txtRechazo,coLi,grupoL);
    });

    function rechazarPedido(numPedido,txtRechazo,coLi,grupoL) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (jsonData.TYPE == "OK") {
                    ...
                    setTimeout(function() {$("#divPedidos"+grupoL+"").empty();showTableP(coLi,grupoL,'1');}, 2000);
                } else {
                    Swal.fire(jsonData.TYPE + ': ' + jsonData.MESSAGE);
                    $("#rechazoModal").modal("hide");
                }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (jsonData.TYPE == "OK") {
                        ...
                        setTimeout(function() {$("#divPedidos"+grupoL+"").empty();showTableP(codigo_liberacion,grupoL,'1');}, 2000);
                    } else {
                        swalWithBootstrapButtons.fire(
                            jsonData.MESSAGE,
                            '',
        ...
        if (selected.length === 0) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (rolL == 'UsuarioMC') {
                        codigoL = $("#codigo").val();
                        setTimeout(function() {$("#divPedidosDI").empty();showTableP(codigoL,'DI','1');}, 4000);
                    }else{
                        codigoL =  "<?php echo $codigo_liberacion ?>";
                        setTimeout(function() {$("#divPedidosDI").empty();showTableP(codigoL,'DI','1');}, 4000);
                    }
        ...
        if (selected.length === 0) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (rolL == 'UsuarioMC') {
                        codigoL = $("#codigo").val();
                        setTimeout(function() {$("#divPedidosIN").empty();showTableP(codigoL,'IN','1');}, 4000);
                    }else{
                        codigoL =  "<?php echo $codigo_liberacion ?>";
                        setTimeout(function() {$("#divPedidosIN").empty();showTableP(codigoL,'IN','1');}, 4000);
                    }
        ...
        if (selected.length === 0) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (rolL == 'UsuarioMC') {
                        codigoL = $("#codigo").val();
                        setTimeout(function() {$("#divPedidosCO").empty();showTableP(codigoL,'CO','1');}, 4000);
                    }else{
                        codigoL =  "<?php echo $codigo_liberacion ?>";
                        setTimeout(function() {$("#divPedidosCO").empty();showTableP(codigoL,'CO','1');}, 4000);
                    }
        ...
        if (selected.length === 0) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (rolL == 'UsuarioMC') {
                        codigoL = $("#codigo").val();
                        setTimeout(function() {$("#divPedidos03").empty();showTableP(codigoL,'03','1');}, 4000);
                    }else{
                        codigoL =  "<?php echo $codigo_liberacion ?>";
                        setTimeout(function() {$("#divPedidos03").empty();showTableP(codigoL,'03','1');}, 4000);
                    }
        ...
        if (selected.length === 0) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (rolL == 'UsuarioMC') {
                        codigoL = $("#codigo").val();
                        setTimeout(function() {$("#divPedidos02").empty();showTableP(codigoL,'02','1');}, 4000);
                    }else{
                        codigoL =  "<?php echo $codigo_liberacion ?>";
                        setTimeout(function() {$("#divPedidos02").empty();showTableP(codigoL,'02','1');}, 4000);
                    }
        ...
        if (selected.length === 0) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (rolL == 'UsuarioMC') {
                        codigoL = $("#codigo").val();
                        setTimeout(function() {$("#divPedidos07").empty();showTableP(codigoL,'07','1');}, 4000);
                    }else{
                        codigoL =  "<?php echo $codigo_liberacion ?>";
                        setTimeout(function() {$("#divPedidos07").empty();showTableP(codigoL,'07','1');}, 4000);
                    }
