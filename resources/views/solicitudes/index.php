...
<div class="container-fluid px-4">
    ...
    <h1 class="mt-4">Liberar Solicitudes</h1>
    <div class="mb-3 divS" >
        </br>
    ...
    <p id="pHeder"></p>
    <!--<p> <?php /* echo "Usuario: ".$user." | Código de Liberación: ".$codigo_liberacion */ ?></p>-->
</div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (jsonData.TYPE == "OK") {
                    ...
                    //setTimeout(function() {$("#divSolicitudes").empty();showTableS(codigoL,1);}, 2000);
                } else {
                    Swal.fire(jsonData.TYPE + ': ' + jsonData.MESSAGE);
                    $("#rechazoModal").modal("hide");
                }
                ...
                if (rolL == 'UsuarioMC') {
                    codigoL = $("#codigo").val();
                    setTimeout(function() {$("#divPedidos"+grupoL+"").empty();showTableP(coLi,grupoL,'1');}, 4000);
                }else{
                    codigoL =  "<?php echo $codigo_liberacion ?>";
                    setTimeout(function() {$("#divPedidos"+grupoL+"").empty();showTableP(coLi,grupoL,'1');}, 4000);
                }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (jsonData.TYPE == "OK") {
                            ...
                            setTimeout(function() {$("#divSolicitudes").empty();showTableS(codigo_liberacion,'1');}, 2000);
                        } else {
                            //Swal.fire(jsonData.TYPE + ': ' + jsonData.MESSAGE);
                            swalWithBootstrapButtons.fire(
                                jsonData.MESSAGE,
    ...
    if (selected.length === 0) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                codigoL =  "<?php echo $codigo_liberacion ?>";
                setTimeout(function() {$("#divSolicitudes").empty();showTableS(codigoL,'1');}, 4000);
