                ...
                <div class="table-responsive text-center">
                    ...
                    if (!($NUMROWS == 0)) {
                        ...
                        if ($TIPO_ERROR == 'E') {
                            ...
                            echo "
                            <table class='table table-light table-sm table-responsive table-bordered text-center'>
                            ...
                            foreach ($DATAHEADER as $row) {
                                ...
                                if (count($row) > 0) {
                                    ...
                                    <tr> 
                                        ...
                                        <td>$MATERIAL</td>
                                        <td>$SHORT_TEXT</td>
                                        <td><type='button' onClick=\"getTxtSuministro('" . $PREQ_NO . "','" . $PREQ_ITEM . "')\" class='btn btn-secondary getTxtSuministro'><img src='".URL."css/images/articles_menu.gif'></button></td>
                                        <td>$QUANTITY</td>
                                        <td>$UNIT</td>
                                        <td>$C_AMT_BAPI</td>
                                        <td>$CURRENCY_ISO</td>
