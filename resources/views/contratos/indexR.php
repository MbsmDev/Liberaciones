...
<div class="container-fluid px-4">
    ...
    <h1 class="mt-4">Contratos Directos Rechazados</h1>
    <div class="mb-3 divS" >
        </br>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (numRows >0) {
                ...
                $("#divPedidosCM").append("<div class='card bg-warning text-dark shadow'>No hay ordenes pendientes a liberar</div>");
                $(".cssload-jar").remove();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (jsonData.TYPE == "OK") {
                        ...
                        //codigoL =  "<?php echo $codigo_liberacion ?>";
                        //setTimeout(function() {$("#divPedidosCM").empty();showTableP(codigoL,'CM');}, 2000);
                        rolL = "<?php echo $rol ?>";
    ...
    if (selected.length === 0) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                //codigoL =  "<?php echo $codigo_liberacion ?>";
                //setTimeout(function() {$("#divPedidosCM").empty();showTableP(codigoL,'CM');}, 4000);
